<p>
	<label for="<?php echo $this->get_field_id('mbds_sw_title'); ?>"><?php _e('Widget Title:', MBDS_TEXT_DOMAIN); ?></label>
...
<p>
	<label id="<?php echo $this->get_field_id( 'mbds_sw_stories' ); ?>_label" for="<?php echo $this->get_field_id( 'mbds_sw_stories' ); ?>"><?php _e('Which stories to list:', MBDS_TEXT_DOMAIN); ?></label>
...
<p id="<?php echo $this->get_field_id( 'mbds_sw_genre' ); ?>_p" style="display:<?php echo ($mbds_sw_stories=='genre') ? 'block' : 'none'; ?>">
	<label  for="<?php echo $this->get_field_id('mbds_sw_genre'); ?>"><?php _e('Which genre:', MBDS_TEXT_DOMAIN); ?></label>
...
<p id="<?php echo $this->get_field_id( 'mbds_sw_series' ); ?>_p" style="display:<?php echo ($mbds_sw_stories=='series') ? 'block' : 'none'; ?>">
	<label  for="<?php echo $this->get_field_id('mbds_sw_series'); ?>"><?php _e('Which series:', MBDS_TEXT_DOMAIN); ?></label>
