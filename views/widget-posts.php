<p>
	<label for="<?php echo $this->get_field_id('mbds_pw_title'); ?>"><?php _e('Widget Title:', 'mooberry-story'); ?></label>
...
<p id="<?php echo $this->get_field_id( 'mbds_pw_count' ); ?>_p">
	<label  for="<?php echo $this->get_field_id('mbds_pw_count'); ?>"><?php _e('How many:', 'mooberry-story'); ?></label>
