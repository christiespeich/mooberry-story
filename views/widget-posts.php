<p>
	<label for="<?php echo $this->get_field_id('mbds_pw_title'); ?>"><?php _e('Widget Title:', MBDS_TEXT_DOMAIN); ?></label>
...
<p>
	<label id="<?php echo $this->get_field_id( 'mbds_pw_story' ); ?>_label" for="<?php echo $this->get_field_id( 'mbds_pw_story' ); ?>"><?php _e('Which story:', MBDS_TEXT_DOMAIN); ?></label>
...
<p id="<?php echo $this->get_field_id( 'mbds_pw_count' ); ?>_p">
	<label  for="<?php echo $this->get_field_id('mbds_pw_count'); ?>"><?php _e('How many:', MBDS_TEXT_DOMAIN); ?></label>
