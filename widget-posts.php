...
class mbds_Posts_Widget extends WP_Widget {
	function __construct() {
		 parent::__construct(
			...
			// name of the widget
			__('Mooberry Story - Chapters List', MBDS_TEXT_DOMAIN ),
			 
			// widget options
			array (
				'description' => __( 'Displays a list of chapters of a story.', MBDS_TEXT_DOMAIN ),
	...
	function widget( $args, $instance ) {
		...
		if ($posts != null) {
			...
			echo sprintf(__('No %s found', MBDS_TEXT_DOMAIN), $posts_name);
		}
		echo $after_widget;
